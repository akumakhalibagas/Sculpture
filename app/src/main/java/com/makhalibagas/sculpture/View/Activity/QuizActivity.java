...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ujians.add(new Ujian("Quiz BAB 1", "25 menit - 15 soal"));
        ujians.add(new Ujian("Quiz BAB 2", "25 menit - 25 soal"));
        ujians.add(new Ujian("Quiz BAB 3", "25 menit - 25 soal"));
        ujians.add(new Ujian("Quiz BAB 4", "25 menit - 25 soal"));
        ujians.add(new Ujian("Quiz BAB 5", "25 menit - 30 soal"));
